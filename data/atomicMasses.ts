/**
 * Standard atomic weights (g/mol), abridged to sensible precision.
 *
 * Versioned dataset — "data over code" (§2.1). Values for elements without a
 * stable isotope use the mass number of the most stable/common isotope. This
 * table is shared by the stoichiometry engine now and the periodic table
 * (Module 3) later.
 */
export const ATOMIC_MASS: Record<string, number> = {
  ...
  Lr: 262, Rf: 267, Db: 268, Sg: 269, Bh: 270, Hs: 269, Mt: 278, Ds: 281,
  Rg: 282, Cn: 285, Nh: 286, Fl: 289, Mc: 290, Lv: 293, Ts: 294, Og: 294,
};

export function atomicMass(symbol: string): number | undefined {
