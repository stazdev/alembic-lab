...
const ROWS: Row[] = [
  ...
  [109, "Mt", "Meitnerium", "transition-metal", 9, 7, "d"],
  [110, "Ds", "Darmstadtium", "transition-metal", 10, 7, "d"],
  [111, "Rg", "Roentgenium", "transition-metal", 11, 7, "d"],
  [112, "Cn", "Copernicium", "transition-metal", 12, 7, "d"],
  [113, "Nh", "Nihonium", "post-transition-metal", 13, 7, "p"],
  [114, "Fl", "Flerovium", "post-transition-metal", 14, 7, "p"],
  [115, "Mc", "Moscovium", "post-transition-metal", 15, 7, "p"],
  [116, "Lv", "Livermorium", "post-transition-metal", 16, 7, "p"],
  [117, "Ts", "Tennessine", "halogen", 17, 7, "p"],
